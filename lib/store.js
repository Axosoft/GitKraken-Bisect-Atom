...
const stateTransitions = {
  [StateConstants.INIT]: {
    [StateConstants.COMMIT_LIST_LOADING]: (state, { repo }) =>
      R.assoc('repo', repo, state)
  },
  [StateConstants.COMMIT_LIST_LOADING]: {
    [StateConstants.COMMIT_LIST_SHOWN]: (prevState, { commitList }) =>
      R.assoc(['commitListInDescendingOrder'], commitList, prevState)
  },
  ...
  [StateConstants.BISECT_CHECKOUT_TRIGGERED]: {
    ...
    [StateConstants.BISECT_COMPLETED]: R.identity
  },
  ...
  [StateConstants.BISECT_COMPLETED]: {
    [StateConstants.COMMIT_LIST_LOADING]: init
  }
};
